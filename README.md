...
InterviewMirror היא מערכת סימולציה אינטראקטיבית לראיונות עבודה בעברית, המיועדת להכין מועמדים לראיונות אמיתיים. בניגוד לכלים קיימים בשוק, המערכת מנהלת **שיחה דינמית בזמן אמת** – השאלות מותאמות לתשובות המשתמש, ולא נקבעות מראש.
...
### מדדי הניתוח
- **ציון כללי** – ממוצע ציוני ה-LLM לאורך הראיון
- **בהירות** – מבוסס על אורך ועומק התשובות
- **ביטחון** – מבוסס על מילים חזקות מול מילים מהססות
- **מקצועיות** – מבוסס על שימוש במינוח מקצועי
